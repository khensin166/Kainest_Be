...
export const getNoteByIdController = async (c) => {
    const { userId, coupleId } = await getIds(c);
...
export const createNoteController = async (c) => {
    const { userId, coupleId } = await getIds(c);
...
export const updateNoteController = async (c) => {
    const { userId, coupleId } = await getIds(c);
    const noteId = c.req.param("id");
    const body = await c.req.json();
...
export const deleteNoteController = async (c) => {
...
export const getPublicNoteController = async (c) => {
    const noteId = c.req.param("id");
...
export const updateNotePermissionsController = async (c) => {
    const { userId, coupleId } = await getIds(c);
    const noteId = c.req.param("id");
    const body = await c.req.json();
