 ...
 */
const safeParseGowa = async (resp) => {
 ...
 */
export const proxyGetDevices = async (c) => {
    try {
 ...
 */
export const proxyCreateDevice = async (c) => {
    try {
 ...
 */
export const proxyDeleteDevice = async (c) => {
    try {
 ...
 */
export const proxyLogoutDevice = async (c) => {
    try {
        const id = c.req.param("id");
 ...
 */
export const proxyGetDeviceLogin = async (c) => {
    try {
        const id = c.req.param("id");
