 ...
 */
export async function sendGroupMessageViaGowa(groupId, message) {
 ...
 */
export const getActiveGroupsController = async (c) => {
    try {
 ...
 * Hanya bisa diakses oleh Admin/Super Admin.
 */
export const blastMessageController = async (c) => {
