...
export const getBudgetStatusController = async (c) => {
...
export const getAiAdviceController = async (c) => {
    const userId = c.get("userId");
    const categoryId = c.req.param("categoryId");
...
export const seedCategoriesController = async (c) => {
    try {
...
export const evaluateBudgetController = async (c) => {
    const userId = c.get("userId");
...
export const getTransactionDetailController = async (c) => {
    const userId = c.get("userId");
...
export const updateTransactionController = async (c) => {
    const userId = c.get("userId");
...
export const deleteTransactionController = async (c) => {
    const userId = c.get("userId");
    const transactionId = c.req.param("id");
...
export const getPocketsController = async (c) => {
    const userId = c.get("userId");
...
export const upsertPocketController = async (c) => {
    const userId = c.get("userId");
    const body = await c.req.json();
...
export const deletePocketController = async (c) => {
    const userId = c.get("userId");
    const categoryId = c.req.param("categoryId");
...
export const bulkSetupPocketsController = async (c) => {
    const userId = c.get("userId");
    const body = await c.req.json();
...
export const classifyTransactionController = async (c) => {
    const userId = c.get("userId");
    const body = await c.req.json();
    if (!body.text) {
